  ...
  return (
    <div className="h-fit px-4 xs:px-0 xs:pl-24 sm:px-6 lg:px-8 bg-black sm:bg-black lg:bg-black border-t-2 border-[#017373] max-w-full">
      ...
      <div className="w-full xl:w-3/5 text-white px-4 sm:px-10 md:px-14 lg:px-32 py-6 sm:py-14 md:py-20 lg:py-32">
        ...
        <p className="font-text py-4 text-sm sm:text-base">
          Experience the power of smart note-taking and transform the way you work today.
        </p>
        <div className="flex w-fit h-fit gap-1 bg-white my-6 rounded-md">
          <input className="w-[221px] text-black m-2 px-2 text-md font-text" placeholder="Enter your email" />
      ...
      <div className="hidden xl:block my-16 mx-32">
        <Image src="/AbstractShapes.png" width={363} height={483} alt="HeroSection" />
      </div>
    </div>
      ...
      <div className="flex flex-col w-full h-fit justify-center py-4 text-white">
        <div className="text-center px-4 sm:px-8 lg:px-16">
          <h1 className="font-text font-bold text-4xl xs:text-2xl sm:text-5xl lg:text-6xl">
            <span className="bg-gradient-to-tr from-[#017373] to-[#AAD9D1] text-transparent bg-clip-text">
              Pricing
            </span> & Plans
          </h1>
          <p className="font-text font-normal text-[#737373] px-4 sm:px-12 lg:px-24 mx-auto max-w-4xl text-wrap text-base sm:text-lg lg:text-xl xs:text-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 w-full h-fit justify-evenly py-6 px-24 xs:px-12 md:gap-8">
          <div className="border-[#017373] border-2 rounded-xl w-full h-full p-4 bg-white shrink-0 xs:">
            ...
            <h1 className="font-text text-4xl sm:text-5xl lg:text-6xl text-black font-bold py-3 mx-5 xs:text-3xl">
          ...
          <div className="border-[#017373] border-2 rounded-xl w-full h-full p-4 bg-black shrink-0">
            ...
            <h1 className="font-text text-4xl sm:text-5xl lg:text-6xl text-white font-bold py-3 mx-5 xs:text-3xl">
