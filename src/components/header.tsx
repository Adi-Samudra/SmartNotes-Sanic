export default function Header() {
    return (
        <div className="bg-black w-full h-fit grid grid-cols-4 justify-items-center px-20 py-8 gap-10 items-center">
            <div className="flex h-fit w-full">
                <div className="border-[#017373] border-4 rounded-lg fill-cyan-700">
                    <svg width="26" height="26" viewBox="0 0 26 26" fill="#00838F" xmlns="http://www.w3.org/2000/svg" className="fill-[#017373]">
                ...
                <p className="text-white mt-1 px-2 text-xl font-text">
                    SmartNotes
                </p>
            </div>
            <div className="text-white flex col-span-2 justify-around h-fit w-fit gap-20 font-text">
                <p className="h-fit w-[1/3] text-center">
                    Features
                </p>
                <p className="text-white h-fit w-[1/3] text-center font-text">
                    Pricing
                </p>
                <p className="text-white h-fit w-[1/3] text-center font-text">
                    Support
            ...
            <div className="w-[167px] h-fit flex justify-self-end bg-gradient-to-tr from-[#017373] to-[#AAD9D1] rounded-md justify-center">
                <button className="px-2 my-2 text-black font-text">
                    Get Started
                </button>
